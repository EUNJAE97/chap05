...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 2. 여러 개 의 1차원 배열의 주소를 관리하는 배열 생성(heap) */
//        iarr1 = new int[][]; -> 크기를 지정하지 않으면 에러
//        iarr1 = new int[][4]; -> 주소를 묶어서 관리할 배열의 크기를 지정하지 않으면 에러
        iarr1 = new int[3][];
         ...
         * 할당 후에 아무런 값을 대입하지 않더라도 heap 영역에는 값이 없는 상태로 공간을 생성할 수 없기에
         * 기본 값이 담겨 있다. */
